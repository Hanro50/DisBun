...
public class BotCon {
	...
	/**
	 * Get the active JDA instance @return The JDA instance @throws
	 * IllegalStateException if the JDA instance is not running @throws
	 */

	public static JDA getJDA() throws IllegalStateException {
		try {
			if (isRunning()) {
				jda.awaitReady();
				return jda;
