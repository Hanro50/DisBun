...
public class ComLink extends AbsConfig {
	...
	private ComLink() {
		...
		if (NEWCONFIG)
			Register("Version of this file\n Do not edit", Verstatic,CurVer);
		else
			Register("Version of this file\n Do not edit", Verstatic, "0.0.0");
	...
	public static void UpdateCheck() {
		if (CurVer.equalsIgnoreCase(Self.get(Verstatic)))
			return;
		Debug.out("Updating Discord_Config file");
		Debug.out(Self.get(Verstatic) + " -> " +CurVer);
