...
public class Methodchanger {
	...
	static final String[] Default = {
			"(First line is ignored)#type (0-playing,1-Streaming,2-Listening,3-Watching,4-Custom(Broken)),Message,Link", "1,message!",
			"0,minecraft,", "1,the Disbun github page,https://github.com/Hanro50/DisBun" };

	public static void load() {
		if (enabled) {
			deload();
		}
		if (BPlugin.Config.MethodChangerenabled()) {
			...
			timer = new Timer();
			timer.schedule(new Updateter(), 10, 60000 * BPlugin.Config.MethodChangerUpdate());
		}
	...
	static public class Updateter extends TimerTask {
